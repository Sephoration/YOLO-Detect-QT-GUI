# -*- coding: utf-8 -*-
"""
脚本名称：6-Divide-dataset.py
功能描述：将YOLO数据集划分为训练集和验证集，创建标准的YOLO数据集目录结构
...
# 数据集配置
# 目标路径：划分后的数据集保存目录
dataset_root_target = "./dataset/Triangle_labelme_25_1"      
# 源路径：原始数据集目录
dataset_root_src = "D:\code\YOLO11-pose\Triangle_labelme_25"  
# 原始图像目录
...
print('\n数据集划分完成！')
print(f'训练集保存路径：{target_train}')
print(f'验证集保存路径：{target_val}')
