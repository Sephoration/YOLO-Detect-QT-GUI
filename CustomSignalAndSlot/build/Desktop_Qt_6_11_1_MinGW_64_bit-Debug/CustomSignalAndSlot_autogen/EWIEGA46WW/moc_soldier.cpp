...
namespace {
struct qt_meta_tag_ZN7SoldierE_t {};
} // unnamed namespace

template <> constexpr inline auto Soldier::qt_create_metaobjectdata<qt_meta_tag_ZN7SoldierE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Soldier, qt_meta_tag_ZN7SoldierE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Soldier::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SoldierE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SoldierE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7SoldierE_t>.metaTypes,
    nullptr
} };
...
void *Soldier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SoldierE_t>.strings))
